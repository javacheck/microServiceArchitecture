package cn.lastmiles.alipay.model.builder.trade;

import cn.lastmiles.alipay.bean.ExtendParams;
import cn.lastmiles.alipay.bean.GoodsDetail;
...
public class AlipayTradePayRequestBuilder extends RequestBuilder {
    ...
    public String validate() {
        ...
        if (StringUtils.isEmpty(bizContent.outTradeNo)) {
            return ("out_trade_no should not be NULL!");
        }
        ...
        if (StringUtils.isEmpty(bizContent.storeId)) {
            return ("store_id should not be NULL!");
        }
