package cn.lastmiles.alipay.model.builder.monitor;

import cn.lastmiles.alipay.config.Constants;
import cn.lastmiles.alipay.model.builder.RequestBuilder;
import cn.lastmiles.alipay.model.hb.EquipStatus;
import cn.lastmiles.alipay.model.hb.ExceptionInfo;
import cn.lastmiles.alipay.model.hb.PosTradeInfo;
import cn.lastmiles.alipay.model.hb.Product;
import cn.lastmiles.alipay.model.hb.SysTradeInfo;
import cn.lastmiles.alipay.model.hb.TradeInfo;
import cn.lastmiles.alipay.model.hb.Type;
...
public class AlipayHeartbeatSynRequestBuilder extends RequestBuilder {
    ...
    public String validate() {
        ...
        if (StringUtils.isEmpty(bizContent.equipmentId)) {
            return ("equipment_id should not be NULL!");
        }
        if (bizContent.equipmentStatus == null) {
            return ("equipment_status should not be NULL!");
        }
