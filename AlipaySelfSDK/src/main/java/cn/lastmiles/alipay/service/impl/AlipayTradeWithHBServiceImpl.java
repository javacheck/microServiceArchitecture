...
import cn.lastmiles.alipay.service.impl.hb.HbListener;
import cn.lastmiles.alipay.service.impl.hb.TradeListener;
 ...
 *
 *  一定要在创建AlipayTradeService之前调用Config.init("alipayrisk10");设置参数
 *
 */
public class AlipayTradeWithHBServiceImpl extends AbsAlipayTradeService {
    ...
    public AlipayF2FPayResult tradePay(AlipayTradePayRequestBuilder builder) {
        ...
        logger.info("trade.pay bizContent:" + request.getBizContent());
