package cn.lastmiles.pay.alipay.demo;
...
import cn.lastmiles.pay.pos.alipay.config.Configs;
import cn.lastmiles.pay.pos.alipay.model.ExtendParams;
import cn.lastmiles.pay.pos.alipay.model.GoodsDetail;
import cn.lastmiles.pay.pos.alipay.model.builder.AlipayHeartbeatSynContentBuilder;
...
import cn.lastmiles.pay.pos.alipay.model.hb.*;
...
import cn.lastmiles.pay.pos.alipay.service.AlipayMonitorService;
import cn.lastmiles.pay.pos.alipay.service.AlipayTradeService;
import cn.lastmiles.pay.pos.alipay.service.impl.AlipayMonitorServiceImpl;
import cn.lastmiles.pay.pos.alipay.service.impl.AlipayTradeServiceImpl;
import cn.lastmiles.pay.pos.alipay.service.impl.AlipayTradeWithHBServiceImpl;
import cn.lastmiles.pay.pos.alipay.utils.Utils;
import cn.lastmiles.pay.pos.alipay.utils.ZxingUtils;
...
public class Main {
	...
	private static String pid="2088021174383713";
	
	private static String appid="2016022901171357";
	
	private static String privateKey="";
	
	private static String publicKey="MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCws8CB6MJUHitDagQMVlnGAD5cT7hAx3Q2LWV3FO1djy/aJrTe18+e8gkfYRsIgbGb+b9Vrg4cSfVnbvgMd3Zm+QUfxcitxHTG1krfnhh9wYazCbSV2uQ21WYyerXn7WgpmjlrbK7CXb8znJ6IhxB3xthAOuTv7TmpkAq5VN2UewIDAQAB";
    ...
    static {
         ...
         */
    	Configs configs = new Configs(pid, appid, privateKey, publicKey);;
...
//        String authCode = "286399918342265510"; // 已用条码
        String authCode = "282750180117518084"; // 已用条码
...
//        String discountableAmount = "1.00"; //
        ...
        String providerId = "282057710414548747";
        ...
        log.info("result is :"+result.getTradeStatus());
        log.info("response is :"+result.getResponse().toString());
    ...
    public void test_trade_query() {
        ...
        String outTradeNo = "tradepay14587852042542972799";
