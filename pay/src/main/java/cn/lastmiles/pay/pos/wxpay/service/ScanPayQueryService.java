...
public class ScanPayQueryService extends BaseService{
    ...
    public ScanPayQueryService(Configure configure) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        super(Configure.PAY_QUERY_API,configure);
    }
