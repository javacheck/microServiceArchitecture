...
public class ScanPayService extends BaseService{
    ...
    public ScanPayService(Configure configure) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        super(Configure.PAY_API, configure);
    }
