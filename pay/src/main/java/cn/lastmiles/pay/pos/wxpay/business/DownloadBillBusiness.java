...
import cn.lastmiles.pay.pos.wxpay.protocol.downloadbill_protocol.DownloadBillResData;
import cn.lastmiles.pay.pos.wxpay.service.DownloadBillService;
...
public class DownloadBillBusiness {
    ...
    public DownloadBillBusiness(Configure configure) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
    	this.setConfigure(configure);
    	downloadBillService = new DownloadBillService(configure);
    }
