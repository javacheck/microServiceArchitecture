...
import cn.self.cloud.commonutils.aliyun.Client;
import cn.self.cloud.commonutils.aliyun.Request;
import cn.self.cloud.commonutils.aliyun.Response;
import cn.self.cloud.commonutils.aliyun.constant.Constants;
import cn.self.cloud.commonutils.aliyun.constant.ContentType;
import cn.self.cloud.commonutils.aliyun.constant.HttpHeader;
import cn.self.cloud.commonutils.aliyun.constant.HttpSchema;
import cn.self.cloud.commonutils.aliyun.enums.Method;
import cn.self.cloud.commonutils.aliyun.util.MessageDigestUtil;
