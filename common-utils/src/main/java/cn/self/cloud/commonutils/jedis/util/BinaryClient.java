...
import cn.self.cloud.commonutils.jedis.util.Protocol.Command;
import cn.self.cloud.commonutils.jedis.util.Protocol.Keyword;
...
import static  cn.self.cloud.commonutils.jedis.util.Protocol.Command.*;
import static cn.self.cloud.commonutils.jedis.util.Protocol.Command.EXISTS;
import static cn.self.cloud.commonutils.jedis.util.Protocol.Command.PSUBSCRIBE;
import static cn.self.cloud.commonutils.jedis.util.Protocol.Command.PUNSUBSCRIBE;
import static cn.self.cloud.commonutils.jedis.util.Protocol.Command.SUBSCRIBE;
import static cn.self.cloud.commonutils.jedis.util.Protocol.Command.UNSUBSCRIBE;
import static  cn.self.cloud.commonutils.jedis.util.Protocol.Keyword.*;
import static  cn.self.cloud.commonutils.jedis.util.Protocol.toByteArray;
