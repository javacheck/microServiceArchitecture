...
import cn.self.cloud.commonutils.jedis.exceptions.JedisConnectionException;
...
import cn.self.cloud.commonutils.simple.util.RedisInputStream;
import cn.self.cloud.commonutils.simple.util.RedisOutputStream;
