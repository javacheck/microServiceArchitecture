...
var ZeroClipboard = {
	...
	setMoviePath: function(path) {// set path to ZeroClipboard.swf
		this.moviePath = path;
	},
	...
	getDOMObjectPosition: function(obj, stopObj) {// get absolute coordinates for dom element
		var info = {
			left: 0, 
			top: 0, 
	...
	Client: function(elem) {// constructor for new simple upload client
		this.handlers = {};
...
ZeroClipboard.Client.prototype = {
	...
	glue: function(elem, appendElem, stylesToAdd) {
		...
		var box = ZeroClipboard.getDOMObjectPosition(this.domElement, appendElem);// find X/Y position of domElement

		this.div = document.createElement('div');// create floating DIV above element
	...
	setText: function(newText) {// set text to be copied to clipboard
	...
	receiveEvent: function(eventName, args) {// receive event from flash
		eventName = eventName.toString().toLowerCase().replace(/^on/, '');
