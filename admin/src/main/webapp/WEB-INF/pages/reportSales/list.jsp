...
function getExe() {
	...
	window.open("${contextPath}/reportSales/list/ajax/list-by-search?beginTime="+beginTime
					+"&endTime="+endTime+"&storeId="+storeId+"&sort="+sort+"&source="+source);
}
function callback1(){
...
<body>
	<m:list title="商品销售统计" id="reportSalesList" callback="callback1"
		listUrl="${contextPath }/reportSales/list/list-data" 
