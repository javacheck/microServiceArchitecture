...
function getExe() {
	...
	window.open("${contextPath}/reportUser/list/ajax/list-by-storeSearch?beginTime="+beginTime
...
<body>
	<m:list title="会员统计" id="reportUserList"
		listUrl="${contextPath }/reportUser/storeList/storeList-data" 
