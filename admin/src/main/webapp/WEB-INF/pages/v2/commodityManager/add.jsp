...
$(function(){
	$("#addProductStock").click(function(){
		...
		"<td class='text-td'>"+
			...
			"<input type='checkbox' name='infinite' onclick='operationStock(this);' id='infinite' value='-99' class='form-control text-input-fl'/>设为无限库存"+
		"</td>"+
		"<td>"+
			// 缺货提醒 
		...
		<div class='panel-body'>
			<form id="commodityManagerAddForm" method='post' repeatSubmit='1' autocomplete="off" enctype="multipart/form-data" class='form-horizontal' action="${contextPath }/commodityManager/save">
				...
				<table border="1" id="productStock_Table" class="text-c col-md-10">
					...
					<tr class="bg-c">
						<td><input name="value" id="value_1" value="${product.shortName }" maxlength="50" class="form-control"/></td>
						<td><input name="value" id="value_2" value="${product.shortName }" maxlength="50" class="form-control"/></td>
						<td>
							<!-- 单位  -->
							<select class="form-control" id="unitId" name="unitId" style="width: auto">
								<option value="">无</option>  
						...
						<td class="text-td">
							<!-- 库存数量  -->
							<input type="text" name="stock" placeholder="不填默认为0" class="text-input-" id="stock" value="0">
							<input type="checkbox" name="infinite" id="infinite" onclick="operationStock(this);" value="-99" class="form-control text-input-fl"/>设为无限库存
						</td>
						<td>
							<!-- 缺货提醒  -->
							<input type="text" name="alarmValue" class='form-control' id="alarmValue" value="0" >
				...
				<div class="form-group">
					...
					<div class="col-md-2">
						<input type="text" name="sort" class='form-control' id="sort" maxlength="7">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-2">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="weighing" checked="checked" value="0" >&nbsp;&nbsp;否
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-2">
						<input type="checkbox" name="shelves" checked="checked" value="0" >&nbsp;&nbsp;收银端上架
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="checkbox" name="shelves" checked="checked" value="2" >&nbsp;&nbsp;APP端上架
					</div>
			    ...
			    <div class="form-group">
					...
					<div class="col-md-2">
						<input type="radio" name="returnGoods" checked="checked" value="1" >&nbsp;&nbsp;是
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="form-group">
					...
					<div id="divPicture" class="col-md-2">
						...
						<input type='hidden' id="picture" name="picture" class='form-control' value="${store.picture }"/>
						<input type="hidden" id="pictureFileCache" name="pictureFileCache" value="${store.picture }"/>
				...
				<div class="form-group">
					...
					<div class="col-md-2">
						<textarea id="remarks"  name="remarks" value="${productStock.remarks }" placeholder="上限150字" cols=15 rows=5  class='form-control' maxlength="150">${productStock.remarks }</textarea>
					</div>
				</div>
