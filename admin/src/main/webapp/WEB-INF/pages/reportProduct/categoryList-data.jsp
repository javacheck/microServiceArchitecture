...
<m:table pageNo="${page.pageNo }" pages="${page.pages }"
	...
	<thead>
		<tr> 
			...
			<th class="two">参考销售成本<span class="arrows" name="numAsc" value="7"></span><span class="arrows boult" name="numAsc" value="8"></span></th>
			<th class="two">销售额<span class="arrows" name="numAsc" value="9"></span><span class="arrows boult" name="numAsc" value="10"></span></th>
